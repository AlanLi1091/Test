...
with urlopen("https://developers.flowworks.com/fwapi/v1/c22cb202-f0ee-439b-97af-0c1b17e04f0a/site/8757/channel/1183/data/startdate/20191230000000") as ss2_wf_json:
    ss2_wf = json.load(ss2_wf_json)
with urlopen("https://developers.flowworks.com/fwapi/v1/c22cb202-f0ee-439b-97af-0c1b17e04f0a/site/8757/channel/1184/data/startdate/20191230000000") as ss2_wl_json:
...
export_csv = df.to_csv(r'C:\Users\allan\Desktop\githubtest\Test\Sanitary_Sewer_2_RT191230.csv', index = None, header = True)
print(df)
